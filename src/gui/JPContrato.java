...
public class JPContrato extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTFIdSimdCardContrato = new javax.swing.JTextField();
        ...
        jBLimpiarAbonado.setBounds(540, 200, 90, 33);
        ...
        jCBGeneroAbonado.setBounds(130, 130, 200, 27);
        ...
        jCBTipoDocumentoAbonado.setBounds(430, 10, 200, 27);
        ...
        jCBImeiAbonado.setBounds(430, 160, 200, 27);
        ...
        jTFCodigoEmpleado.setBounds(140, 10, 100, 27);
        ...
        jTFNombreEmpleado.setBounds(140, 40, 200, 27);
        ...
        jCBGeneroEmpleado.setBounds(470, 10, 170, 27);
        ...
        jCBEstadoCivilEmpleado.setBounds(470, 40, 170, 27);
        ...
        jCBCargoEmpleado.setBounds(470, 70, 170, 27);
        ...
        jCBTipoContratoEmpleado.setBounds(140, 130, 200, 27);
        ...
        jCBSucursalEmpleado.setBounds(470, 100, 170, 27);
        ...
        jBLimpiarEmpleado.setBounds(550, 140, 90, 33);
        ...
        jDCFechaNacimientoEmpleado.setBounds(140, 100, 200, 29);

        jDCFechaIngresoEmpleado.setDateFormatString("dd MMM yyyy");
        jPanel3.add(jDCFechaIngresoEmpleado);
        jDCFechaIngresoEmpleado.setBounds(140, 70, 200, 29);
        ...
        jBConsultarEmpleado.setBounds(400, 140, 120, 33);
        ...
        jBConsultarPlan.setBounds(390, 120, 90, 33);
        ...
        jBLimpiarPlan.setBounds(510, 120, 90, 33);
        ...
        jLabel18.setBounds(390, 10, 100, 17);
        ...
        jTtarifa_msj_textoPlan.setBounds(500, 10, 160, 27);
        ...
        jBConsultarSimCard.setBounds(260, 100, 100, 33);
        ...
        jBLimpiarSimCard.setBounds(390, 100, 100, 33);

        jLabel10.setText("Autorizacion Roaming");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(270, 70, 110, 17);

        jLabel11.setText("Numero Tel");
        jPanel5.add(jLabel11);
        jLabel11.setBounds(10, 40, 70, 17);
        ...
        jCBautorizacion_roamingSimCard.setBounds(390, 70, 100, 27);
        ...
        jCBActivacion_InternetSimCard.setBounds(130, 70, 100, 27);

        jLabel27.setText("Activacion de Internet");
        jPanel5.add(jLabel27);
        jLabel27.setBounds(10, 70, 140, 17);
        ...
        jLabel28.setBounds(270, 40, 100, 17);

        jLabel29.setText("Bloqueado por robo");
        jPanel5.add(jLabel29);
        jLabel29.setBounds(270, 10, 100, 17);
        ...
        jCBactivacion_correoSimCard.setBounds(390, 40, 100, 27);

        jLabel12.setText("Codigo");
        jPanel5.add(jLabel12);
        jLabel12.setBounds(10, 10, 60, 17);
        ...
        jCBbloqueado_por_roboSimCard.setBounds(390, 10, 100, 27);
        ...
        jBLimpiarContrato.setBounds(500, 120, 110, 33);
        ...
        jBGenerarContrato.setBounds(310, 120, 150, 33);
        ...
        jTFValor.setBounds(330, 50, 79, 27);

        jLabel5.setText("Valor");
        jPanel6.add(jLabel5);
        jLabel5.setBounds(260, 50, 45, 17);
    ...
    private void jBConsultarPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConsultarPlanActionPerformed
        LinkedList consulta = new LinkedList();
        try {
            consulta = controladorPlan.consultar(
                    jTFCodigoPlan.getText(),
                    jTFtarifa_otro_operadorPlan.getText(),
                    jTFtarifa_msj_multimediaPlan.getText(),
                    jTtarifa_msj_textoPlan.getText());

            Object[][] s = new Object[consulta.size()][4];
            for (int i = 0; i < consulta.size(); i++) {
                Plan plan = (Plan) consulta.get(i);
                if (plan.getCod_plan() != null) {
                    s[i][0] = plan.getCod_plan();
                    s[i][1] = plan.getTarifa_otro_operador();
                    s[i][2] = plan.getTarifa_msj_multimedia();
                    s[i][3] = plan.getTarifa_msj_texto();
            ...
            ///remover filas
            jTResultadosPlan.setModel(myModel);
            jTResultadosPlan.setRowSorter(new TableRowSorter(myModel));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jBLimpiarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBLimpiarEmpleadoActionPerformed
        limpiarCamposConsultarEmpleado();
        jBConsultarEmpleado.doClick();
...
int guardar = -1;
    ...
    private void limpiarCamposConsultarPlan() {
        jTFCodigoPlan.setText("");
        jTFtarifa_msj_multimediaPlan.setText("");
        jTFtarifa_otro_operadorPlan.setText("");
        jTtarifa_msj_textoPlan.setText("");

    }

    private void limpiarCamposConsultarEmpleado() {
        jTFCodigoEmpleado.setText("");
        jTFNombreEmpleado.setText("");
        jCBCargoEmpleado.setSelectedIndex(0);
        jCBEstadoCivilEmpleado.setSelectedIndex(0);
        jCBGeneroEmpleado.setSelectedIndex(0);
        jCBSucursalEmpleado.setSelectedIndex(0);
        jCBTipoContratoEmpleado.setSelectedIndex(0);
        jDCFechaIngresoEmpleado.setDate(null);
        jDCFechaNacimientoEmpleado.setDate(null);
    }

    private void limpiarCamposConsultarAbonado() {
    ...
    private void limpiarCamposConsultarSimCard() {
        jTFCodigoSimCard.setText("");
        jTFnum_telefonoSimCard.setText("");
        jCBActivacion_InternetSimCard.setSelectedIndex(0);
        jCBbloqueado_por_roboSimCard.setSelectedIndex(0);
        jCBactivacion_correoSimCard.setSelectedIndex(0);
        jCBautorizacion_roamingSimCard.setSelectedIndex(0);
    }
    ...
    private javax.swing.JTextField jTFIdSimdCardContrato;
